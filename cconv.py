...
class ContinuousConv(nn.Module):
    def __init__(self, inc, ouc, k=3, act=True) -> None:
        ...
        self.conv_x = CConv(inc, ouc, 0, k)
        self.conv_y = CConv(inc, ouc, 1, k)
...
class CConv(nn.Module):
    def __init__(self, in_ch, out_ch, morph, kernel_size=3, if_offset=True, extend_scope=1):
        ...
        # two types of the CConv (along x-axis and y-axis)
    ...
    def forward(self, f):
        ...
        input_shape = f.shape
        dsc = CC(input_shape, self.kernel_size, self.extend_scope, self.morph)
